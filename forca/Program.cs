namespace JogoForca4
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ExibirAnimacao("inicio"); // chama função definida abaixo que exibe uma vinheta de abertura
            ...
            do //inicio jogo
            {
                ...
                do //inicio partida
                {
                    ...
                    do
                    {
                        ExibirTelaJogo(erros, palavraOculta, dica, letrasUsadas);
                        Console.Write($"\n\n Digite uma letra entre a e z (sem acentos): ");
                        letra = Console.ReadLine().ToLower();
                    } while (!EhLetraValida(letra, letrasUsadas)); // chama função definida abaixo para validar a letra
        ...
        static bool EhLetraValida(string verLetra, string usadas)
        {
        ...
        static void ExibirTelaJogo(int erros, string pOculta, string textoDica, string usadas)
        {
            Console.Clear();
            Console.WriteLine("  +---+   ");
            Console.WriteLine("  |   |   ");
        ...
        static void ExibirAnimacao(string tipo)
        {
